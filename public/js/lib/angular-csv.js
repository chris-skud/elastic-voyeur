  ...
  directive('exportCsv', ['ResultsTable', function(ResultsTable) {
    return {
      ...
      template: '<div class="csv-wrap">' +
        ...
        '<a class="hidden-link" ng-hide="true" download="seerdata.csv">sdf</a>' +
      '</div>',
      link: function(scope, element, attrs) {
        ...
        subject.bind('click', function(e) {
          link[0].href = ResultsTable.getCsvData(); // want to generalize and pull this object into this module
          link[0].click();
        });
      }
    };
